...
/* Link active work */
let linkWork = document.querySelectorAll('.work-item');
...
sr.reveal('.home-data');
sr.reveal('.home-handle', {delay: 700 , origin: 'bottom'});
sr.reveal('.home-social', {delay: 900 , origin: 'left'});
sr.reveal('.home-scroll', {delay: 900 , origin: 'right'});
